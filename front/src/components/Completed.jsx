...
const CompletedOrderItem = ({ order, isSeller = false }) => {
    ...
    const otherParty = isSeller ? order.buyerID : order.sellerID;
                    ...
                    >
                        ...
                        <Stack spacing={1} flex={1}>
                            ...
                            <Typography variant="body2" color="text.secondary">
                                {isSeller ? 'Buyer' : 'Seller'}: {otherParty.firstName} {otherParty.lastName}
                            </Typography>
                            {isSeller && (
                                <Typography variant="body2" color="text.secondary">
                    ...
                    >
                        {chatMessages.map((msg, index) => (
                            <ChatMessage
                                key={index}
                                isUser={isSeller ? 
                                    msg.sender._id !== order.buyerID._id :
                                    msg.sender._id !== order.sellerID._id}
                            >
